...
if USE_ATLAS:
    ...
    NEURAL_MEM_WEIGHT_RESIDUAL = False  # incompatible with omega: per-chunk prev_weights would give window gradients different base points (asserted off in NeuralMemory)
