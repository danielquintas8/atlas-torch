...
**Validation loss on held-out FineWeb** (nats, lower is better): Atlas 3.4003, no-window 3.3965, chunk-wise Titans 3.3949, memory-free control 3.4560, Titans at 4e-4 3.7676. Having a memory is worth about 0.06 nats. Which update rule runs it is not distinguishable at this scale, and neither is the Omega window.
